...
const DEFAULT_SIZES = ["39", "40", "41", "42", "43"]
                    ...
                    <Fragment>
                        <div className="wrapper my-5">
                            <form className="shadow-lg" onSubmit={submitHandler} encType='multipart/form-data'>
                                ...
                                <div className="form-group">
                                    <label htmlFor="size_field">Kích thước</label>
                                    <select className="form-control" id="size_field" onChange={(e) => { 
                                         setSizes([...e.target.selectedOptions].map(el => el.value))
                                    }} multiple>
